Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/kandluis/SwiftyWalkthrough"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.authors      = { "Luis Perez" => "luis.perez.live@gmail.com" }
  s.platform     = :ios, "8.0"
  s.source       = { :git => 'https://github.com/kandluis/SwiftyWalkthrough.git', :tag => s.version }
